    ...
    return (
                ...
                <div className=" relative ">
                    ...
                    <div className="lg:max-w-xl lg:pr-5 relative z-40">
                        ...
                        <div className="mt-10 flex flex-col items-center md:flex-row">
                            {/* <Button variant="filled" className="mb-3 h-12 w-full md:mr-4 md:mb-0 md:w-auto">
                                View More
                            </Button> */}
                            <Button variant="text" className="group inline-flex items-center font-semibold text-g1" onClick={() => navigate("/menu")}>
                                See Our Menu
                                <FontAwesomeIcon icon={faArrowRight} className="ml-2 text-g1" />
                            </Button>
                        </div>
                    </div>
        ...
        <div className=" absolute -bottom-24 left-10 z-0  opacity-10 "> 
            <svg width="800px" height="800px" viewBox="0 0 24 24" className="w-96 z-0  h-full    object-fill fill-gray-300 text-gray-300" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M12 6C12 5.44772 11.5523 5 11 5C10.4477 5 10 5.44772 10 6V16C10 16.5523 10.4477 17 11 17C11.5523 17 12 16.5523 12 16V6ZM9 9C9 8.44772 8.55228 8 8 8C7.44772 8 7 8.44772 7 9V16C7 16.5523 7.44772 17 8 17C8.5523 17 9 16.5523 9 16V9ZM15 9C15 8.44772 14.5523 8 14 8C13.4477 8 13 8.44772 13 9V16C13 16.5523 13.4477 17 14 17C14.5523 17 15 16.5523 15 16V9ZM18 13C18 12.4477 17.5523 12 17 12C16.4477 12 16 12.44772 16 13V16C16 16.5523 16.4477 17 17 17C17.5523 17 18 16.5523 18 16V13ZM6 15C6 14.4477 5.55228 14 5 14C4.44772 14 4 14.4477 4 15V16C4 16.5523 4.44772 17 5 17C5.5523 17 6 16.5523 6 16V15ZM21 15C21 14.4477 20.5523 14 20 14C19.4477 14 19 14.4477 19 15V16C19 16.5523 19.4477 17 20 17C20.5523 17 21 16.5523 21 16V15ZM4 18C3.44772 18 3 18.4477 3 19C3 19.5523 3.44772 20 4 20H21C21.5523 20 22 19.5523 22 19C22 18.4477 21.5523 18 21 18H4Z"></path>
            </svg>
        </div>
